...
class SPAM:
    ...
    def banner(self):
        ...
        title = '\n\n\n---By Nguyen Viet Anh depp zai nhat he mat troi ---'
        banner = '''\n 
__      ___      _                  _     
\ \    / (_)    | |     /\         | |    
 \ \  / / _  ___| |_   /  \   _ __ | |__  
   ...
   \  /  | |  __/ |_ / ____ \| | | | | | |
    ...
    def send_otp(self):
        ...
        try:
            ...
            if 'Thành công' in response:
                print(self.format_print("NVA",f"MOMO: {response}"))
            else:
                print(self.format_print("NVA",f"MOMO: "+response))
        except:
            print(self.format_print("NVA",f"MOMO: BAD REQUESTS LIMIT!"))
    def send_code(self):
        json_data = {
                'user': self.phone,
    ...
    def Gbay(self):
        ...
        try:
            ...
            print(self.format_print("NVA",f"GBAY: SUCCESS!"))
        except:
            print(self.format_print("NVA",f"GBAY: ERROR!"))
    ...
    def moca(self):
        ...
        try:
            ...
            print(self.format_print("NVA",f"MOCA: SUCCESS!"))
        except:
            print(self.format_print("NVA",f"MOCA: ERROR!"))
    ...
    def zalopay(self):
        try:
            ...
            print(self.format_print("NVA",f"ZALOPAY: SUCCESS!"))
        except:
            print(self.format_print("NVA",f"ZALOPAY: ERROR!"))
    def tiki(self):
        try:
            json_data = {
                    'phone_number': self.phone,
            ...
            print(self.format_print("NVA",f"TIKI: SUCCESS!"))
        except:
            print(self.format_print("NVA",f"TIKI: ERROR!"))
    def meta_vn(self):
        try:
            params = {
                'api_mode': '1',
            ...
            print(self.format_print("NVA",f"METAVN: SUCCESS!"))
        except:
            print(self.format_print("NVA",f"METAVN: ERROR!"))
    def vntrip(self):
        try:
            json_data = {
                'feature': 'register',
            ...
            print(self.format_print("NVA",f"VNTRIP: SUCCESS!"))
        except:
            print(self.format_print("NVA",f"VNTRIP: ERROR!"))
    ...
    def run(self):
        while True:
            self.banner()
            self.phone = input(self.format_input("NVA",f"NHAP SDT DE TOOL CUA VIET ANH SPAM : "))
            if self.phone != '0937576173':
                if len(self.phone) == 10:
                    break
                print(self.format_print("NVA", "S IN THOI DI <10 S XIN NHP LI !"))
            if self.phone == '0937576173':
                print(self.format_print("NVA", "LÀM ON DUNG SPAM SO DIEN THOAI VietAnh!"))
            time.sleep(3)
